        ...
        <div className='pt-[70px] '>
            <div className='grid grid-cols-1 md:grid-cols-2 px-12 md:px-[100px]  gap-16'>
                ...
                <div>
                    ...
                    <p>There are many variation of passages of Lorem Ipsum <br /> available, but the majority have suffered alteration in some <br />form, by injected humour, or randomised words which dont <br />look even slightly believable. </p>
                    <p className='py-[20px]'>the majority have sufere alteration in some <br /> form, by injected humour, or randomised words which <br /> dont look even slightly believable. </p>
