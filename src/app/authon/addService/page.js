    ...
    return (
        <div>
            ...
            <form className="w-3/3 rounded-lg " onSubmit={handleSubmit(onSubmit)}>
              ...
              <div> 
                    <input className="border-2 rounded-lg py-1 px-3 w-full" placeholder="Service name..." {...register("name", { required: true })} />
                    {errors?.name && <span>This field is required</span>}
                </div>
                <div>
                    <input className="border-2 rounded-lg py-1 px-3 w-full" placeholder="Service price..." {...register("email", { required: true })} />
              ...
              <div> 
                    <input className="border-2 rounded-lg py-1 px-3 w-full" placeholder="Text here..." {...register("name", { required: true })} />
                    {errors?.name && <span>This field is required</span>}
                </div>
                <div>
                    <input className="border-2 rounded-lg py-1 px-3 w-full" placeholder="Service Type..." {...register("email", { required: true })} />
                    {errors?.email && <span>This field is required</span>}
                </div>
